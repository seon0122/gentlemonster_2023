<header>
        ...
        <div class="h_right">
            ...
            <a href="./login.html" class="login"><img src="./images/icon_login.png" alt="로그인"></a>
            <a href="./review.html" class="cart"><img src="./images/icon_cart.png" alt="장바구니"></a>
            <a href="#" class="nav"><img src="./images/icon_menu.png" alt="메뉴열기"></a>
        </div>
        <!-- nav 클릭 시 open nav -->
        <div id="open_nav">
            <!-- 닫기버튼 -->
